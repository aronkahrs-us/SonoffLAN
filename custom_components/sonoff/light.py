...
class XLight(XEntity, LightEntity):
    ...
    async def transiton(
        ...
        br1 = brightness
        ct0 = self.color_temp_kelvin or self.min_color_temp_kelvin
...
class XLightB1(XLight):
    ...
    def get_params(self, brightness, color_temp_kelvin, rgb_color, effect) -> dict:
        if brightness or color_temp_kelvin:
            ...
            # Map kelvin to device level: cold (>5250K), neutral (>3350K), warm
            if color_temp_kelvin > 5250:
                params = {"channel0": ch, "channel1": "0"}
            elif color_temp_kelvin > 3350:
...
class XLightB05B(XLightB02):
    ...
    _attr_max_color_temp_kelvin = 6536
    ...
    def set_state(self, params: dict):
        ...
        if "colorTemp" in params:
            self._attr_color_temp_kelvin = conv(
                ...
                0,
                100,
                self._attr_min_color_temp_kelvin,  # yellow (warm)
                self._attr_max_color_temp_kelvin,  # blue (cold)
            )
